...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	while (!exiting)
	{
		...
		break;
		case 1:
			g_glRender->TurnLeft(g_hiResTimer->GetElapsedSeconds(1));
			break;
		case 2:
			g_glRender->TurnRight(g_hiResTimer->GetElapsedSeconds(1));
			break;
		case 3:
			g_glRender->MoveForward(g_hiResTimer->GetElapsedSeconds(1));
			break;
		case 4:
			g_glRender->MoveBackward(g_hiResTimer->GetElapsedSeconds(1));
			break;
		default:
			break;
		}
